...
namespace ShareWithMe.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
       ...
       // private readonly SmtpClient _smtpClient;
        ...
        public AuthController(IUserManager userManager, IConfiguration config, IFileManager fileManager, IHostingEnvironment env,  IHubContext<ProgressHub, IProgressHub> hub, ILogger<AuthController> logger)
        {
            _logger = logger;
            _hub = hub;
